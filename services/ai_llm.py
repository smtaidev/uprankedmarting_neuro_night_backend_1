...
class AIService:
    ...
    async def question_ai_validation_check(
        ...
        user_prompt = (
            ...
            "4. If not similar or no existing questions, is this new question relevant to questions a call center agent might ask a caller in the organization's call center (e.g., verifying caller identity, gathering information, addressing inquiries, processing requests, or managing issues related to the organization's services or workflows)?\n"
